...
export const state = () => ({
  userName: "",
  question: {},
  askmequestionUrl: "http://10.138.0.2:5914/api",
  // askmequestionUrl: "http://http://10.138.0.2:5914/api",
  urlcode: ""
})
...
export const actions = {
  ...
  async questionUpload({ commit, state }, question) {
    ...
    const data = await this.$axios.$post(
      'http://10.138.0.2:5914/api/uploadQuestion',
      question
    )
